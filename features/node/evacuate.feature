Feature: Evacuate
  ...
  Scenario: Evacuate node with dry run option should only list but not actually do the remove
    ...
    When I run the :create client command with:
      | f | https://raw.githubusercontent.com/openshift-qe/v3-testfiles/master/infrastructure/nodeselector/hello-pod-env-dev.yaml |
    Then the step should succeed
    When I run the :create client command with:
      | f | https://raw.githubusercontent.com/openshift-qe/v3-testfiles/master/infrastructure/nodeselector/hello-pod-env-qe.yaml |
    Then the step should succeed
  ...
  Then the step should succeed
  When I run the :create client command with:
      | f | https://raw.githubusercontent.com/openshift-qe/v3-testfiles/master/infrastructure/nodeselector/hello-pod-env-dev2.yaml |
  Then the step should succeed
  When I run the :create client command with:
      | f | https://raw.githubusercontent.com/openshift-qe/v3-testfiles/master/infrastructure/nodeselector/hello-pod-env-qe.yaml |
  Then the step should succeed
