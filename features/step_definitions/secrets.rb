Given /^the azure file secret name and key are stored to the clipboard$/ do
  ...
  step %Q{admin creates a StorageClass from "https://raw.githubusercontent.com/openshift-qe/v3-testfiles/master/persistent-volumes/azure-file/azfsc-ACONLY.yaml" where:}, table(%{
