Feature: Check links in Openshift
  ...
  Scenario: check doc links in web
    ...
    When I run the :check_default_documentation_link_in_get_started web console action
    Then the step should succeed

    # check Documentation link on /console help
    When I run the :check_default_documentation_link_in_console_help web console action
    Then the step should succeed

    # check docs link in about page
    When I run the :check_default_documentation_link_in_about_page web console action
    Then the step should succeed
    When I run the :check_cli_reference_doc_link_in_about_page web console action
    Then the step should succeed
    When I run the :check_basic_cli_reference_doc_link_in_about_page web console action
    Then the step should succeed

    # check docs link on command line page
    When I run the :check_get_started_with_cli_doc_link_in_cli_page web console action
    Then the step should succeed
    When I run the :check_cli_reference_doc_link_in_cli_page web console action
    Then the step should succeed
    When I run the :check_basic_cli_reference_doc_link_in_cli_page web console action
    Then the step should succeed
