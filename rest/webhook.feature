Feature: Webhook REST Related Tests
  ...
  Scenario: Verify guestbook example of Atomic Host works
    ...
    When I run the :create client command with:
      | f | <%= BushSlicer::HOME %>/features/tierN/testdata/cases/509014/redis-master-controller.yaml |
    Then the step should succeed
    ...
    Then the step should succeed
    When I run the :create client command with:
      | f | <%= BushSlicer::HOME %>/features/tierN/testdata/cases/509014/frontend-controller.yaml |
    Then the step should succeed
