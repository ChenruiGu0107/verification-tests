Feature: system metric related tests
  ...
  Scenario: Deploy Prometheus with node selector via ansible
    ...
    And metrics service is installed with ansible using:
      | inventory | <%= BushSlicer::HOME %>/features/tierN/testdata/logging_metrics/OCP-15538/inventory |
  ...
  Scenario: Deploy Prometheus via ansible to non-default namespace
    ...
    And metrics service is installed with ansible using:
      | inventory | <%= BushSlicer::HOME %>/features/tierN/testdata/logging_metrics/OCP-15544/inventory |
  ...
  Scenario: Deploy Prometheus with container resources limit via ansible
    ...
    Given I create a project with non-leading digit name
    And metrics service is installed with ansible using:
      | inventory | <%= BushSlicer::HOME %>/features/tierN/testdata/logging_metrics/OCP-15529/inventory |
  ...
  Scenario: Deploy Prometheus with dynamic pv via ansible
    ...
    And metrics service is installed in the system using:
      | inventory | <%= BushSlicer::HOME %>/features/tierN/testdata/logging_metrics/OCP-17206/inventory |
  ...
  Scenario: Path for prometheus additional alert rules file is not exist
    ...
    Given I create a project with non-leading digit name
    And metrics service is installed with ansible using:
      | inventory     | <%= BushSlicer::HOME %>/features/tierN/testdata/logging_metrics/OCP-15535/inventory |
      | negative_test | true                                                                                                   |
  ...
  Scenario: DeleteExpiredMetrics job is already dropped from code
    ...
    Given I create a project with non-leading digit name
    And metrics service is installed with ansible using:
      | inventory | <%= BushSlicer::HOME %>/features/tierN/testdata/logging_metrics/OCP-12234/inventory |
    And a pod becomes ready with labels:
