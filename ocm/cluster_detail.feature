Feature: Only for case related to cluster detail page
  ...
  Scenario: Monitoring tab should show correct message for cluster in installing/disconnected status and no metrics data from telemetry
    ...
    When I perform the :click_monitoring_tab web action with:
      |parameter_needed|no|
    Then the step should succeed
    When I perform the :check_installing_cluster_monitoring_tab web action with:
      |parameter_needed|no|
    Then the step should succeed
    ...
    When I perform the :click_monitoring_tab web action with:
      |parameter_needed|no|
    Then the step should succeed
    When I perform the :check_disconnected_cluster_monitoring_tab web action with:
      |parameter_needed|no|
    Then the step should succeed
